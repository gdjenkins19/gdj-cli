...
const argv = require("optimist")
	.usage("--api [DEMO|ADMIN|EVENT|...] --source [file|directory|project|list] --path [sql file|directory path] --list [filename]")
	.demand(["api","source", "path"])
	.argv;


module.exports = () => {
	core.dataDisco(core.serviceEnum[argv.api]);
	...
	console.log(`DB_Builder ... ${argv.source}: ${argv.path}`);
	...
	switch (argv.source) {
		...
		case "list":
			...
			break;
		default:
			console.log(`DB_Builder ... Unknown --source (${argv.source})`);
	}
